    ...
    <MotionConfig transition={{ duration: 1.5 }}>
      <motion.div className="h-[80vh]" initial={{ opacity: 0 }} animate={{ opacity: 1 }}>
        ...
        <div className="h-full w-full flex flex-col justify-center items-center">
          ...
          <p className="my-4 w-[35vw]">
            Lorem ipsum dolor sit amet consectetur adipisicing elit. Architecto laborum unde nemo cumque molestias illum
            molestiae tempora cum quam maxime!
          </p>
